...
export const ProprietorSection = () => {
  return (
    <section className="relative h-screen min-h-[700px] overflow-hidden flex items-center bg-arch-black/5">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto bg-white shadow-xl p-8 md:p-12 lg:p-16 animate-fade-in-up">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div className="w-full lg:w-[40%] flex justify-center">
              <div className="relative group">
                ...
                <img
                  src={proprietorImage}
                  alt="Tilak Ranjit"
                  className="w-full max-w-[380px] aspect-[4/5] object-cover shadow-2xl border border-white"
                />
              </div>
            </div>
            ...
            <div className="w-full lg:w-[60%] flex flex-col">
              ...
              <div className="space-y-4">
                <p className="text-base font-light leading-relaxed text-arch-medium max-w-xl text-justify">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="flex items-center gap-4">
                  <Award className="w-6 h-6 text-arch-accent" />
                  <div className="text-xs tracking-widest uppercase text-arch-black font-light">
                    Structural<br />Specialist
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  <ShieldCheck className="w-6 h-6 text-arch-accent" />
                  <div className="text-xs tracking-widest uppercase text-arch-black font-light">
